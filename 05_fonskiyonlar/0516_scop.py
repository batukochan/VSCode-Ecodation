...
# region ornek_1
"""not→ değişkeni her ne kadar fonksiyonda tanımlasak da, 
fonksiyon scope’undan çıktığı anda değişken silinir."""
...
# region ornek_4
"""not→ aynı örnekleri id özelliği ile ram hafıza 
adresini ekrana yazarak ta farkına varabiliriz"""
'''
def scopeTest():
    a = 34
    print(id(a))
...
# region ornek_5
"""
not→ değişken adı aynı olsa da, fonksiyon scope’unda 
ATAMA YAPILDIĞI anda, o değişken, main bloktaki o değişken 
olmaktan çıkıyor DEMİŞTİK. Olsun istiyor isek GLOBAL keyword 
kullanırız"""
...
# region ornek_7
"""
not→ fonksiyona argüman olarak LIST gönderdiğimizde,
fonksiyon scope’unda ATAMA YAPMAK, main bloktaki o 
değişkeni DEĞİŞTİRMEZ demiştik, bu durum LIST içinde aynıdır"""
...
"""
not→ fonksiyona argüman olarak LIST gönderdiğimizde, 
fonksiyon scope’unda DEL ile LIST'i silmek, main bloktaki 
o listeyi DEĞİŞTİRİR."""
